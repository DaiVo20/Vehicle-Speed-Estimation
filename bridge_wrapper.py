        ...
        while True: # while video is running
            ...
            if not os.path.exists(f'./detected_frame/{frame_num}.txt'):
                ...
                if yolo_dets is None:
                    ...
                    with open(f'./detected_frame/{frame_num}.txt', 'w') as f:
                ...
                with open(f'./detected_frame/{frame_num}.txt') as f:
                    for line in f:
            ...
            for track in self.tracker.tracks:  # update new findings AKA tracks
                ...
                track = calculate_speed(track, [(646, 341), (1111, 327)], [(601, 412), (1166, 392)], bbox, frame_num)
